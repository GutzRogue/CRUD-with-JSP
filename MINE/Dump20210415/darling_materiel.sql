...
CREATE TABLE `materiel` (
  ...
  `ModeleName` varchar(45) DEFAULT NULL,
  `NumeroSerie` varchar(45) DEFAULT NULL,
  `Quantite` int DEFAULT NULL,
  `Numere_inventaire` int DEFAULT NULL,
  `etat` tinyint DEFAULT NULL,
  `DateAffactation` date DEFAULT NULL,
  `Localisation` int DEFAULT NULL,
  PRIMARY KEY (`idMateriel`),
  KEY `idLocalisation_idx` (`Localisation`),
  CONSTRAINT `idLocalisation` FOREIGN KEY (`Localisation`) REFERENCES `localisation` (`idLocalisation`)
